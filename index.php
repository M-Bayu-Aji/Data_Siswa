...
if (isset($_GET['hapus'])) {
    ...
    $_SESSION['dataSiswa'] = array_values($_SESSION['dataSiswa']); // Reindex the array
    header('Location: ' . $_SERVER['PHP_SELF']);
    exit;
}
?>
            ...
            <form action="" method="post">
                ...
                <div class="d-flex gap-1 text-xl-center">
                    ...
                    <?php if (!empty($_SESSION['dataSiswa'])): ?>
                        <a href="cetak.php" style="color: white; text-decoration: none;" class="btn btn-success"><i class="fa-solid fa-print"></i> Cetak</a>
